        ...
        <b-container fluid>
          ...
          <b-row v-if="!sistema.cuenta">
            <b-col cols="12">
              <b-alert show variant="secondary" class="p-1">
                El sistema no tiene asociada una cuenta todavía; <b-link variant="primary" @click="crearCuentaSistema">¿
                  Crear cuenta del sistema?</b-link>
              </b-alert>
          ...
          <b-row>
            <b-col cols="12" md="6">
              ...
              <b-form-group
                description="Divisa con la que va a operar Travelpoints, ¿ en que divisa vamos a reflejar las ganancias del sistema?">
                <template #label>
                ...
                <validation-provider name="divisa_id" rules="required" #default="{ errors, valid }">
                  ...
                  <v-select v-model="formulario.divisa_id" :options="divisas" label="nombre"
            ...
            <b-col cols="12" md="6">
              <b-form-group description="Descripción del sistema breve ...">
                ...
                <validation-provider name="descripcion" #default="{ errors, valid }">
                  <b-form-textarea v-model="formulario.descripcion" :rows="1" placeholder="Descripción del sistema ..."
                    :state="valid">
            ...
            <b-col cols="12" md="6">
              <b-form-group label="¿ Paypal ?" description="Vas a integrar Paypal como metodo de pago ">
                ...
                <validation-provider name="paypal" rules="required" #default="{ valid, errors }">
                  ...
                  <b-form-radio-group v-model="formulario.paypal" button-variant="primary"
                    :options="[{ text: 'Sí', value: true }, { text: 'No', value: false }]" :state="valid">
          ...
          <b-row>
            <b-col cols="12">
              ...
              <b-form-file ref="refBanner" v-model="banner_principal" plain class="d-none" accept="image/*"
                @input="updateBanner">
              ...
              <small>
                ...
                Clics sobre la imagen para actualizarla, cargue una imagen ultra wide preferiblemente de este tamaño, 1300
                x 300 PX. Esta imagen es mostrada en los principales Banner de las paginas Publicas.
              </small>
            </b-col>
          </b-row>
                  ...
                  <tr v-for="(red_social, i) in formulario.redes" :key="i">
                    ...
                    <td>
                      <validation-provider name="url" rules="required|url" #default="{ valid, errors }">
                        <b-form-input v-model="red_social.url" :state="valid"
                          placeholder="https://facebook.com/travelpoints" />
                        <b-form-invalid-feedback :state="valid">
                          {{ errors[i] }}
                        </b-form-invalid-feedback>
                      </validation-provider>
                    ...
                    <td>
                      <validation-provider name="redes.icono" rules="required" #default="{ valid, errors }">
                        <v-select v-model="red_social.icono" :options="marcasFontAwesome" :reduce="option => option"
                          :filterBy="filtradoIcon">
          ...
          <b-row>
            ...
            <b-col cols="12" v-if="formulario.cjdropshipping" class="mt-1">
              <p> <strong class="text-danger">NOTA:</strong> Una vez generado el token de acceso, no es necesario que
                vuelva regenerar el token de forma manual, ya que el sistema ha creado un servicio que hace esto por usted
                cada 15 días.</p>
            </b-col>
          </b-row>
            ...
            <template v-if="formulario.cjdropshipping.cuenta">
              ...
              <b-col cols="12" md="6">
                ...
                <b-form-group label="Es cuenta de prueba?">
                  <b-form-radio-group :options="optionsSandbox" v-model="formulario.cjdropshipping.cuenta.isSandbox"
                    disabled>
                  </b-form-radio-group>
                </b-form-group>
            ...
            <b-col cols="12" md="6">
              <b-form-group
                ...
                <validation-provider name="negocio.divisa_id" rules="required" #default="{ errors, valid }">
                  ...
                  <v-select v-model="formulario.negocio.divisa_id" :options="divisas.filter(val => !val.principal)"
                    label="nombre" :reduce="(option) => option.id"></v-select>
