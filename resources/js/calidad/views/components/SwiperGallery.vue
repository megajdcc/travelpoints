<template>
  ...
  <b-card class="gallerie">
      <!-- swiper1 -->
      <swiper-container ref="swiperTop" class="swiper-gallery gallery-top mySwiper" 
      v-bind="swiperOptions" thumbs-swiper=".mySwiper2" >

        <swiper-slide v-for="(data, index) in swiperData" :key="index">
            <b-img :src="data.img" fluid heigth="350px" class="imagen-gallerie" :style="{objetFit:coverImg ? 'cover !important' : 'contain !important' }"/>
        </swiper-slide>
