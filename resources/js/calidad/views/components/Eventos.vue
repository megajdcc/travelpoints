...
import useEventosList from '@core/utils/eventos/useEventosList.js'
...
export default {
  ...
  setup(props) {
    ...
    const actions = useEventosList({ destino: destino.value ? destino : null, atraccion: atraccion.value ? atraccion : null })
