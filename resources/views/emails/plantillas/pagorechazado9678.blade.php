...
El motivo de mi correo es para confirmar a usted que hemos recibido y rechazado el pago con número de referencia **{{ $nro_referencia }}** realizado por la cantidad de {{ $monto_pago }} MXN.  
