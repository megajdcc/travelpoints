         ...
         <b-row>
            <b-col cols="12">
               <b-table ref="refTable" :fields="tableColumns" :items="fetchData" :sort-by="sortBy"
                  :sort-desc="isSortDirDesc" primary-key="id" hover bordered small striped show-empty empty-text="Sin Data"
                  responsive>
                  ...
                  <template #row-details="{ item }">
                     <table class="table table-sm table-hover responsive">
                        ...
                        <tr>
                           <td>
                              <b-img :src="`/storage/negocios/logos/${item.logo}`" responsive thumbnail
                                 style="max-height:350px" />
                           </td>

                           <td>
                              <b-img :src="`/storage/negocios/fotos/${item.foto}`" responsive thumbnail
                                 style="max-height:350px" />
                           </td>
                  ...
                  <template #cell(actions)="{ item }">
                     <b-button-group size="sm">
                        ...
                        <b-button variant="danger" @click="eliminar(item.id)" v-if="$can('delete', 'solicitudes')">
