  ...
  >
    ...
    >
      ...
      <div class="customizer-section">
        ...
        >
          <span class="font-weight-bold">Menú colapsado</span>
          <b-form-checkbox
        ...
        <div class="d-flex justify-content-between align-items-center mt-2">
          <span class="font-weight-bold">Menú oculto</span>
          <b-form-checkbox
      ...
      <div class="customizer-section">
        ...
        <b-form-group
          ...
          label="Color de la barra de navegación superior"
        >
          <div
        ...
        <!-- Navbar Type -->
        <b-form-group :label="layoutType === 'vertical' ? 'Tipo de barra de navegación' : 'Menu Type'">
          <b-form-radio-group
            v-model="navbarType"
            name="navbar-type"
            :options="navbarTypes"
      ...
      <div class="customizer-section">
        ...
        <!-- Footer Type -->
        <b-form-group label="Tipo de pie de página">
          <b-form-radio-group
            v-model="footerType"
            name="footer-type"
            :options="footerTypes"
