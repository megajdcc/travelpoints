					...
					<tr>
						<td colspan="2">
							@if(isset($filtro['pais']) && !empty($filtro['pais']))
								<h2>Equipo por País: <b>{{ $filtro['pais'] }}</b></h2>
							@else
								<h2>Equipo Promotor</h2>
              @endif
				...
				<thead>
					<tr>
						@if(isset($filtro['pais']) && !empty($filtro['pais']))
								<th class="">Num.</th>
								<th class="">Destino</th>
							  <th class="">Total Coordinadores</th>
								<th class="">Total Líderes</th>
								<th class="">Total Promotores</th>
						@else
								<th class="">Num.</th>
								<th class="">País</th>
								<th class="">Total Coordinadores</th>
						...
						<tr style="border-bottom:1px solid rgba(0,0,0,0.4)">
								...
								@if(isset($filtro['pais']) && !empty($filtro['pais']))
									  <td>{{ $equipo->destino }}</td>
										<td>{{ $equipo->coordinadores }}</td>
										<td>{{ $equipo->lideres }}</td>
										<td>{{ $equipo->promotores }}</td>
