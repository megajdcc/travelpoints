  ...
  <b-card>
    <validation-observer ref="formValidate" #default="{ handleSubmit }">
      <b-form @submit.prevent="handleSubmit(guardar)">
        ...
        <form-wizard color="#0293c9" :title="null" :subtitle="null" stepSize="sm" finish-button-text="Guardar"
          back-button-text="Anterior" next-button-text='Siguiente' class="steps-transparent mb-1"
              ...
              <b-row>
                ...
                <b-col cols="12" md="4">
                  ...
                  <b-form-group
                    ...
                    <validation-provider name="fecha_fin" :rules="!formulario.recurrente ? 'required' : ''"
                  ...
                  <template v-if="formulario.recurrente">
                    <b-form-group>
                      ...
                      <validation-provider name="tipo_recurrencia" rules="required" #default="{ valid, errors }">
                        <b-form-radio-group v-model="formulario.tipo_recurrencia" :options="tipoRecurrencias"
                          :state="valid" @change="cambiarDias">
                        </b-form-radio-group>
                        <b-form-invalid-feedback :state="valid">
                          {{ errors[0] }}
                        </b-form-invalid-feedback>
                    ...
                    <section class="d-md-flex justify-content-around">
                      <b-form-group
                        ...
                        <validation-provider name="hora_inicio" :rules="!formulario.all_dia ? 'required' : ''"
                          #default="{ valid, errors }">
                      ...
                      <b-form-group
                        ...
                        <validation-provider name="hora_fin" :rules="!formulario.all_dia ? 'required' : ''"
                          #default="{ valid, errors }">
                          <b-form-timepicker :disabled="formulario.all_dia" hour12 label-close-button="Cerrar"
