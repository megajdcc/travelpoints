         ...
         <b-row class="mb-1">
            ...
            <b-col cols="12" md="6">
               <b-input-group size="sm">
                  ...
                  <template #append>
                     <b-button :to="{ name: 'create.categoria-faq' }" v-if="$can('write', 'faqs')" variant="primary"
         ...
         <b-row>
            <b-col cols="12">
               <b-table ref="refTable" :fields="tableColumns" :items="fetchData" :sort-by="sortBy"
                  ...
                  <template #cell(faqs)="{ item }">
                     {{ item.faqs.length }}
                  </template>
                  <template #cell(actions)="{ item }">
                     <b-button-group size="sm">

                        <b-button :to="{ name: 'edit.categoria-faq', params: { id: item.id } }"
                           v-if="$can('update', 'faqs')" variant="primary">
...
import useCategoriaFaqslist from './useCategoriaFaqslist'
