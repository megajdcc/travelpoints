               ...
               <b-col md="6">
                  <div class="d-flex align-items-center justify-content-end">
                     ...
                     <b-input-group size="sm">
                        ...
                        <template #append>
                           <b-button variant="dark" :to="{ name: 'create.divisa' }" v-if="$can('write','divisas')">
         ...
         <b-table ref="refTable" :items="fetchData" responsive :fields="tableColumns" primary-key="id"
            ...
            <template #cell(actions)="{ item }">
               ...
               <b-button-group size="sm">
                  ...
                  <b-button @click="eliminar(item.id)" variant="danger" title="Eliminar Divisa" v-if="$can('delete','divisas')">
...
import useDivisaList from './useDivisaList.js'
import {
   BCard,
   BContainer,
   BRow,
