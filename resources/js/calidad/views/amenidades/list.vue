   ...
   <b-container fluid class="px-0 mx-0">
      ...
      <b-card no-body class="mb-0">
               ...
               <b-col md="6">
                  <div class="d-flex align-items-center justify-content-end">
                     ...
                     <b-input-group size="sm">
                        ...
                        <template #append>
                           <b-button variant="dark" :to="{ name: 'create.amenidad' }" v-if="$can('write','amenidades')">
         ...
         <b-table ref="refTable" :items="fetchData" responsive :fields="tableColumns" primary-key="id"
            :sort-by.sync="sortBy" empty-text="No se encontró ningúna Amenidad" :sort-desc.sync="isSortDirDesc"
            ...
            <template #cell(actions)="{ item }">
               ...
               <b-button-group size="sm">
                  ...
                  <b-button :to="{ name: 'edit.amenidad', params: { id: item.id } }" variant="primary" title="Editar Amenidad">
                     <feather-icon icon="EditIcon" />
                  </b-button>

                  <b-button @click="eliminar(item.id)" variant="danger" title="Eliminar Amenidad">
...
import useAmenidadList from './useAmenidadList'
import {
   BCard,
   BContainer,
   BRow,
