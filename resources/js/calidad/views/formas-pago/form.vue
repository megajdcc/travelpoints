               ...
               <b-container fluid>
                  ...
                  <b-row>
                     <b-col cols="12" md="12">
                        <b-form-group >
                           <template #label>
                              Nombre de la Forma de Pago: <span class="text-danger">*</span>
                           </template>

                           <validation-provider name="nombre" rules="required" #default="{valid,errors}">
                              <b-form-input v-model="formulario.nombre" :state="valid"  placeholder="Nombre de la Forma de Pago..."/>
...
export default {
   ...
   setup(_,{emit}){
      ...
      const { forma: formulario } = toRefs(store.state.formasPago)
